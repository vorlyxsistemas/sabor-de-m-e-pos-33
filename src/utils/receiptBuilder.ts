...
// ============================================================
// GERADOR ÚNICO DE COMANDA HTML
// ============================================================

/**
 * Gera o HTML completo da comanda para impressão.
 * Esta é a ÚNICA fonte de verdade para geração de comandas.
 * Usado tanto na impressão manual quanto na automática.
 */
